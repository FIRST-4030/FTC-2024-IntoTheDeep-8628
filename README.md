...
This repository contains the public FTC SDK for the Into the Deep (2024-2025) for the Chickenados (8628) competition season. It is last year's (CenterStage) robot with odometry pods using 2 dead wheels.

## Welcome!
This GitHub repository contains the source code that is used to build an Android app to control a *FIRST* Tech Challenge competition robot.  To use this SDK, download/clone the entire project to your local computer.

## Requirements
To use this Android Studio project, you will need Android Studio 2024.1.2 (codename Koala) or later.
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;git clone https://github.com/acmerobotics/road-runner-quickstart</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[FIRST Tech Challenge Documentation]([https://ftc-docs.firstinspires.org/index.html](https://ftc-docs.firstinspires.org/en/latest/))
